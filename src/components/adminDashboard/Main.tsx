...
const Main = () => {
    ...
    const setActiveTab = (tab: "blogs" | "qr") => {
        setSearchParams({ tab });
    };
        ...
        <div className="grid grid-cols-5 mt-8 gap-8">
            <div className="col-span-1 bg-[#F5F5F5]/80 rounded-2xl py-1 px-4">
                <div
                    ...
                    className={`my-4 px-4 py-4 rounded-xl cursor-pointer font-semibold hover:bg-white text-lg transition-all duration-300 ${tabParam === "blogs"
